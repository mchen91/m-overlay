...
function PANEL:DebugInputs()
	...
	local damage = self.CHECKPANEL:AddOption(DEBUG_INPUT_C_STICK, "Sandbag damage")
	damage:SetTooltipParent(self.CHECKPANEL)
	damage:SetTooltipTitle("Sandbag damage")
	damage:SetTooltipBody([[Show a more accurate damage on Sandbag.]])
